 ...
 */
#ifdef WIN32
int mxdkcontrol_close(unsigned int fd);
#else /* Linux */
#define mxdkcontrol_close(fd)			close((int)fd)
#endif
 ...
 */
int	mxdkcontrol_set_slot(unsigned int fd, int slot_num, int on);
