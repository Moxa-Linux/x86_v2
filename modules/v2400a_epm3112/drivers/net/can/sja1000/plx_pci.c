...
#define PCI_DEVICE_ID_MOXA_CANBUS 0xa000
...
// XXX
static struct plx_pci_card_info plx_pci_card_info_moxa_canbus_card = {
	"MOXA CANBUS PCI Card", 2,
	PLX_PCI_CAN_CLOCK, PLX_PCI_OCR, PLX_PCI_CDR,
	{0, 0x00, 0x00}, { {0, 0x00, 0x80}, {1, 0x80, 0x80} },
	&plx_pci_reset_common
	/* based on PLX9052 */
};
// END OF XXX
...
static DEFINE_PCI_DEVICE_TABLE(plx_pci_tbl) = {
	{
		/* MOXA CANBUS card */
		PCI_VENDOR_ID_MOXA, PCI_DEVICE_ID_MOXA_CANBUS,
		PCI_ANY_ID, PCI_ANY_ID,
		0, 0,
		(kernel_ulong_t)&plx_pci_card_info_moxa_canbus_card
	},
	{
