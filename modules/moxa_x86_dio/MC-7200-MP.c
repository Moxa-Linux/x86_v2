...
/*
 * For MC-7200-MP, There are 8 DI, 8 DO.
 * IO port bitmap:
 *    DI0 0x301 bit 0
 *    DI1 0x301 bit 1
 *    DI2 0x301 bit 2
 ...
 */
static dio_dev MC_7200_MP = {"MC-7200-MP", 0, 0x0, MAX_DIN_PORT, MAX_DOUT_PORT, gpio, 0};
...
IOADDR_DEF  DOUT[] = {
  {IO_ADDRESS_GP2X, IO_BIT_GP24, "DOUT0", 0xFF}, // IOAddress, DataBit, name, do_stat
  {IO_ADDRESS_GP2X, IO_BIT_GP25, "DOUT1", 0xFF}, //
  {IO_ADDRESS_GP2X, IO_BIT_GP26, "DOUT2", 0xFF}, //
  {IO_ADDRESS_GP1X, IO_BIT_GP15, "DOUT3", 0xFF}, //
  {IO_ADDRESS_GP5X, IO_BIT_GP56, "DOUT4", 0xFF}, //
  {IO_ADDRESS_GP4X, IO_BIT_GP45, "DOUT5", 0xFF}, //
  {IO_ADDRESS_GP3X, IO_BIT_GP33, "DOUT6", 0xFF}, //
  {IO_ADDRESS_GP3X, IO_BIT_GP37, "DOUT7", 0xFF}
};
#else /* MC-7130-MP */
IOADDR_DEF  DIN[] = {
  {IO_ADDRESS_GP2X, IO_BIT_GP20, "DIN0", 0}, // IOAddress, DataBit, name, do_stat (Don't care)
...
u8 MC_7200_MP_dio_inb(dio_dev* mdev, struct dio_set_struct* set)
{ 
	u8 val = 0;

	/* MC-7200-MP uses gpio ioport to control the digital output */
...
void MC_7200_MP_dio_outb(dio_dev* mdev, struct dio_set_struct* set) 
{
	/*
...
void MC_7200_MP_get_outb(dio_dev* mdev, struct dio_set_struct* set) {
...
dio_dev* moxa_platform_dio_init(void){
	...
	register_dio_inb(MC_7200_MP_dio_inb);
	register_dio_outb(MC_7200_MP_dio_outb);
	register_get_dout(MC_7200_MP_get_outb);

	printk("moxa-device-dio, %s: %s series  \n", __FUNCTION__, MC_7200_MP.name);
	return &MC_7200_MP;
}
